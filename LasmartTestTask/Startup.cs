...
using LasmartTestTask.Data.Repositories;
...
namespace LasmartTestTask
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<DataContext>(opt => opt.UseInMemoryDatabase(Configuration.GetConnectionString("TestTask")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, DataContext dataContext)
        {
            ...
            DatabaseInitializer.Initial(app, dataContext);
